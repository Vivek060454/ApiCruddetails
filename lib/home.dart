...
class _HomeState extends State<Home> {
  ...
  fetchdata() async{
    var url =
  Uri.parse("https://crudcrud.com/api/f29a8353dc1142d993bd6ce930c904cb/unicorns");
  ...
  deleteUser(id) async{
    print(id);
    var url =
    Uri.parse("https://crudcrud.com/api/f29a8353dc1142d993bd6ce930c904cb/unicorns/"+id);
